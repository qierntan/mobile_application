...
class InvoicePdfService {
  ...
  static Future<String?> createStripePaymentLink(Invoice invoice) async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.1.102:4242/create-checkout-session'),
      ...
      body: jsonEncode({
        ...
        'success_url':
            'http://192.168.1.102:4242/success?session_id={CHECKOUT_SESSION_ID}&invoice_id=${invoice.id}&customer_email=$customerEmail',
        'cancel_url': 'http://192.168.1.102:4242/cancel',
        'metadata': {
  ...
  static Future<void> setupPaymentSuccessHandler() async {
    ...
    try {
      ...
      print('   -  192.168.1.102:8081 (from emulator to host)');
